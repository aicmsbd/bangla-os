...
echo "[branding] wallpaper / logo / calamares:"
    unsquashfs -ll "$WORK/fs.sqfs" 2>/dev/null | grep -E 'bangla-os|backgrounds/bangla|plymouth/themes/bangla|grub/themes/bangla|neofetch/config|bangla-welcome' | head -28
